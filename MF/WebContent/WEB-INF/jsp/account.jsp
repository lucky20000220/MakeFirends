    ...
    <div class="wrap">
         ...
         <div class="account">
          <form action="doUser" method="get">
                 ...
                 <div class="tsm-box">
                      ...
                      <div class="tsm-a" style="display:block;">                  
                                   <div class="tsm-a1">
                                         ...
                                         <div class="tsm-a3"><input name="User_name" type="text" class="tsm-text1"></div>
                                   </div> 
                                   ...
                                   <div class="tsm-a1">
                                         ...
                                         <div class="tsm-a3"><input name="User_work" type="text" class="tsm-text1"></div>
                                   </div>
                                   <div class="tsm-a1">
                                     <div class="tsm-a2 fl">个人主页：</div>
                                         <div class="tsm-a5"><textarea name="User_explain"class="tsm-area"></textarea></div>
                 ...
                 <div class="tsm-box">
                      <div class="tsm-title">登录信息
                      </div>
                      <div class="tsm-a">
                                   <div class="tsm-a1">
                                         <div class="tsm-a2 fl">登陆账号:</div>
                                         <div class="tsm-a3"><input name="User_accout" type="text" class="tsm-text1"></div>
                                   </div>
 
                                   <div class="tsm-a1">
                                         <div class="tsm-a2 fl">密码：</div>
                                         <div class="tsm-a3"><input name="User_password" type="password" class="tsm-text1"></div>
                                   </div>
                                   <div class="tsm-a1">
                                         <div class="tsm-a2 fl">确认密码：</div>
                                         <div class="tsm-a3"><input name="apssword" type="password" class="tsm-text1"></div>
                                   </div>
                                   
                                 
                        </div>
                 </div>            
           <div class="tsm-href"><input type="submit" class="tsm-btn" value="提交"></div>
 	<input type="hidden" name="hidden" value="zuce"/>
            </form>    
         </div>
...
<div class="login">
    ...
    <div class="login-btm">
    <form action="doUser" method="get">
        <div class="login-d"><input name="name" type="text" class="login-text" placeholder="注册时账帐号"></div>
        <div class="login-d"><input name="password" type="password" class="login-pas" placeholder="密码"></div>
        <div class="login-d"><input type="submit" class="login-btn" placeholder="登录"></div>
        <input type="hidden" name="hidden" value="denglu"/>
        </form>
        <div class="login-f">
             <a href="">忘记密码</a>
...
<div class="reg">
    ...
    <div class="login-btm">
        ...
        <div class="login-d"><input name=""name type="text" class="login-text" placeholder="邮箱/手机号"></div>
        <div class="login-d"><input name="password" type="password" class="login-pas" placeholder="密码"></div>
        <div class="login-d"><input natype="submit" class="login-btn" placeholder="注册"></div>
        <div class="login-f">
             <a href="">忘记密码</a>
        </div>
    </div>
